...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='../dataSets/crackSet-cls', help='dataset path')
    ...
    parser.add_argument('--project', default='val-cls', help='save to project/name')
