...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=r'./crack-seg.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--project', default='val-seg', help='save results to project/name')
