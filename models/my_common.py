...
class CBAMBottleneck(nn.Module):
    ...
    def __init__(self, c1, c2, shortcut=True, g=1, e=0.5, ratio=16,
        ...
        self._CBAM = CBAM(c2, c2, ratio, kernel_size)
...
# C3中嵌入添加CA注意力模块的Bottleneck，并在输出嵌入CA注意力模块
class C3CA_CA(C3_CA):
    # C3 module with CABottleneck()
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
...
# C3中嵌入添加DCN和CA的Bottleneck
class C3DCNCA(C3):
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        c_ = int(c2 * e)
        self.m = nn.Sequential(*(DCNCABottleneck(c_, c_, shortcut, g, e=1.0) for _ in range(n)))


# C3中嵌入添加DCN的Bottleneck，并在输出嵌入CA注意力模块
class C3DCN_CA(C3_CA):
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        c_ = int(c2 * e)
        self.m = nn.Sequential(*(DCNBottleneck(c_, c_, shortcut, g, e=1.0) for _ in range(n)))
...
# C3中嵌入添加DCN和CA的Bottleneck，并在输出嵌入CA注意力模块
class C3DCNCA_CA(C3_CA):
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        c_ = int(c2 * e)
        self.m = nn.Sequential(*(DCNCABottleneck(c_, c_, shortcut, g, e=1.0) for _ in range(n)))
...
# NewC3，新型C3结构将串联Bottleneck结构修改为并联
class NewC3(nn.Module):
...
# NewC3中第二卷积后嵌入CA注意力模块
class NewC3_1CA(nn.Module):
    # Improving C3 by C2F from YOLOv8
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        super().__init__()
        c_ = int(c2 * e)  # hidden channels
...
# NewC3中嵌入添加DCN和CA的Bottleneck
class NewC3DCNCA(NewC3):
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        c_ = int(c2 * e)
        self.m = nn.Sequential(*(DCNCABottleneck(c_, c_, shortcut, g, e=1.0) for _ in range(n)))
...
class NewC3DCNCA_1CA(NewC3_1CA):
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        c_ = int(c2 * e)
        self.m = nn.Sequential(*(DCNCABottleneck(c_, c_, shortcut, g, e=1.0) for _ in range(n)))
...
# NewC3中输出嵌入注意力模块，第二个卷积嵌入CA注意力模块
class NewC3_CA_1CA(nn.Module):
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        super().__init__()
        c_ = int(c2 * e)  # hidden channels
        self.cv1 = Conv(c1, c_, 1, 1)
    ...
    def forward(self, x):
        y1 = self._CA1(self.cv2(x))
        y2 = list([y1, self.cv1(x)])
        y2.extend(m(y2[-1]) for m in self.m)

        return self._CA2(self.cv3(torch.cat(y2, 1)))


# NewC3中嵌入添加DCN的Bottleneck，并在输出嵌入CA注意力模块
class NewC3CA_CA(NewC3_CA):
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        c_ = int(c2 * e)
        self.m = nn.Sequential(*(CABottleneck(c_, c_, shortcut, g, e=1.0) for _ in range(n)))
...
class NewC3CA_CA_1CA(NewC3_CA_1CA):
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        c_ = int(c2 * e)
        self.m = nn.Sequential(*(CABottleneck(c_, c_, shortcut, g, e=1.0) for _ in range(n)))
...
class NewC3DCN_CA_1CA(NewC3_CA_1CA):
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        c_ = int(c2 * e)
        self.m = nn.Sequential(*(DCNBottleneck(c_, c_, shortcut, g, e=1.0) for _ in range(n)))
...
# NewC3中嵌入添加DCN和CA的Bottleneck，并在输出嵌入CA注意力模块
class NewC3DCNCA_CA(NewC3_CA):
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        c_ = int(c2 * e)
        self.m = nn.Sequential(*(DCNCABottleneck(c_, c_, shortcut, g, e=1.0) for _ in range(n)))
...
class NewC3DCNCA_CA_1CA(NewC3_CA_1CA):
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        c_ = int(c2 * e)
        self.m = nn.Sequential(*(DCNCABottleneck(c_, c_, shortcut, g, e=1.0) for _ in range(n)))
...
"""
    注意力方面：C3SE、C3CBAM、C3CA、C3ECA、C3_SE、C3_CBAM、C3_CA、C3_ECA
    C3可替换为：C3CA、C3DCN、C3DCNCA、C3_CA、C3DCN_CA、C3CA_CA、C3DCNCA_CA、
    NewC3、NewC3CA、NewC3DCN、NewC3DCNCA、NewC3_CA、NewC3CA_CA、NewC3DCN_CA、NewC3DCNCA_CA、
...
class ASPPF(nn.Module):
    ...
    def forward(self, x):
        ...
        x2_1 = self.DilationConv2(x)
        x2_2 = self.DilationConv4(x2_1)
        x2_3 = self.DilationConv6(x2_2)
...
class LBP(nn.Module):
    ...
    def forward(self, x):
        ...
        x_numpy = x.cpu().numpy()
        for i, img in enumerate(x_numpy):
            temp = np.zeros(x.shape[1:])
            for j, im in enumerate(img):
                temp[j] = cv2.resize(cal_lbp_feature(im, self.lp, self.lr), x.shape[2:])
