...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
        ...
        if not resume:
            if not opt.noautoanchor:
                check_anchors(dataset, model=model, thr=hyp['anchor_t'], imgsz=imgsz,
                              kmeanspp=opt.kmeanspp, cc=opt.iou, cluster=opt.cluster)  # run AutoAnchor
    ...
    compute_loss = ComputeLoss(model, CIoU=opt.CIoU, EIoU=opt.EIoU, SIoU=opt.SIoU)  # init loss class
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='./weights/yolov5s-obj.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='./cfgs/yolov5s-obj.yaml', help='model.yaml path')
    # parser.add_argument('--data', type=str, default=ROOT / 'crack-obj.yaml', help='dataset.yaml path')
    parser.add_argument('--data', type=str, default='crack-obj.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--project', default='train-obj', help='save to project/name')
    ...
    parser.add_argument('--cluster', action='store_true', help='Clustering judge')
